...
class ResourceService {
    ...
    def createLinkResource(params, User user) {
        ...
        def linkResource = new LinkResource(url: params.url, description: params.description, topic: params.topic, user: session.user)
    ...
    def createDocResource() {
        ...
        def docResource = new DocumentResource(filePath: params.filePath, description: params.description, topic: params.topic, user: session.user)
