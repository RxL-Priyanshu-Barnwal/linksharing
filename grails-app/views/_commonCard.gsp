    ...
    <div class="shadow-lg" style="background-color: #212529; border-radius: 10px;">
        ...
        <div class="row p-3">
            <div class="col-12 d-flex align-items-center" style="background-color: #212529; border-radius: 8px; padding: 10px;">
                ...
                <div style="flex-grow: 1;">
                    <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="text-white mb-1">Peter Jones</h6>
                        <span class="text-muted small">@peterj</span>
                        <span class="badge bg-warning ml-auto text-dark">Food</span>
                    </div>
                    <p class="text-white-50 mb-0 small">Just posted! Check out this delicious recipe or food review.</p>
                </div>
            </div>
            ...
            <div class="col-12 d-flex align-items-center" style="background-color: #212529; border-radius: 8px; padding: 10px;">
                ...
                <div style="flex-grow: 1;">
                    <div class="d-flex justify-content-between align-items-baseline">
                        <h6 class="text-white mb-1">Sarah Williams</h6>
                        <span class="text-muted small">@sarahw</span>
                        <span class="badge bg-danger ml-auto">Lifestyle</span>
                    </div>
                    <p class="text-white-50 mb-0 small">A fresh perspective or update on a recent lifestyle trend.</p>
                </div>
            </div>
        </div>
    </div>
